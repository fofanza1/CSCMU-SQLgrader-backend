...
--start#2.14
UPDATE payments,orders SET payments.paymentDate="2003-07-15" WHERE payments.customerNumber=orders.customerNumber AND payments.checkNumber="JM555205"AND orders.orderDate="2003-05-20";
SELECT customers.customerNumber,customers.customerName,payments.checkNumber,orders.orderDate,payments.paymentDate FROM customers,orders,payments WHERE payments.customerNumber=orders.customerNumber AND payments.checkNumber="JM555205"AND orders.orderDate="2003-05-20" AND payments.customerNumber=customers.customerNumber
--finish#2.14
