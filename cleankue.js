...
function performCleanup() {
  ...
  ki.failed(function(err, ids) {
    ...
    queueIterator(
      ...
      [
        new QueueActionLog(
          "Going to remove job id(%s) for being failed too long"
        ),
  ...
  ki.active(function(err, ids) {
    ...
    queueIterator(
      ...
      [
        new QueueActionLog(
          "Going to remove job id(%s) for being active too long"
        ),
        new QueueActionRemove()
      ]
    );
  ...
  ki.complete(function(err, ids) {
    ...
    queueIterator(
      ...
      [
        new QueueActionLog(
          "Going to remove job id(%s) for being complete too long"
        ),
        new QueueActionRemove()
      ]
    );
